...
export const RESUME_TEMPLATES: ResumeTemplateMeta[] = [
  ...
  },
  {
    id: "minimal-clean",
    name: "Minimal Clean",
    description: "Clean, minimal single-column layout with one teal accent. Quiet typography and generous whitespace.",
    atsScore: 98,
    kinds: ["resume", "cv"],
  ...
  },
  {
    ...
    description: "Developer-focused compact layout with a cyan accent, tight entries, and bold skill ticks.",
    atsScore: 90,
    kinds: ["resume", "cv"],
  ...
  },
  {
    ...
    description: "Refined serif layout for senior and leadership roles: small-caps headers, gold rules, restrained palette.",
    atsScore: 92,
    kinds: ["resume", "cv"],
  ...
  },
  {
    ...
    description: "Two-column dashboard with a dark metrics sidebar and a main narrative column. Great for tech leads.",
    atsScore: 75,
    kinds: ["resume", "cv"],
  ...
  },
  {
    ...
    name: "Academic Europass",
    description: "Europass-style CV with research profile, education, and publications/awards sections in a serif face.",
    atsScore: 90,
    kinds: ["cv"],
  ...
  },
  {
    ...
    description: "Bold, colorful layout for design and creative roles with a violet accent and strong typography.",
    atsScore: 80,
    kinds: ["resume", "cv"],
